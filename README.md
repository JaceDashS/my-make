...
マイメイク（マイメイ）は、生徒ごとに異なる肌状態や希望する方向性に応じて発生する講師側の準備・判断業務をシステム化し、業務負担を軽減することを目的としたシステムです。
...
色相マッチングと PRESET の上位構造については [docs/maimei-color-preset-handoff.md](docs/maimei-color-preset-handoff.md) を参照してください。
