        ...
        >
          <View
            style={[
              styles.checkboxBox,
              {
                backgroundColor: unmountLoginContainer
                  ? palette.primary
                  : palette.soft,
                borderColor: unmountLoginContainer
                  ? palette.primary
                  : palette.border,
              },
            ]}
        ...
        >
          <View
            style={[
              styles.checkboxBox,
              {
                backgroundColor: unmountProfileContainer
                  ? palette.primary
                  : palette.soft,
                borderColor: unmountProfileContainer
                  ? palette.primary
                  : palette.border,
              },
            ]}
