  ...
  return (
    <ScrollView contentContainerStyle={styles.stack}>
      ...
      <Pressable
        ...
        style={[styles.primaryCardAction, {backgroundColor: palette.primary}]}>
        <Text style={[styles.primaryCardActionTitle, {color: palette.primaryText}]}>
          {labels.allChecks}
        </Text>
        <Text style={[styles.primaryCardActionHint, {color: palette.primaryText}]}>
