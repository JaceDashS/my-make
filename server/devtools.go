...
var managedDropStatements = []string{
	"DROP TABLE MAME_USERS CASCADE CONSTRAINTS PURGE",
	"DROP TABLE MAME_LICENSES CASCADE CONSTRAINTS PURGE",
	"DROP TABLE MAME_ACADEMIES CASCADE CONSTRAINTS PURGE",
	"DROP SEQUENCE MAME_USER_CODE_SEQ",
	"DROP SEQUENCE MAME_USERS_SEQ",
	"DROP SEQUENCE MAME_LICENSES_SEQ",
	"DROP SEQUENCE MAME_ACADEMIES_SEQ",
}
